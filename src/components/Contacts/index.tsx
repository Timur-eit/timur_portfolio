      ...
      <div className='contacts-container'>
       ...
       <div>
        {Object.keys(contactList).map((contact) => {
          return (
            <a key={contact} href={contactList[contact].linkPath} className='contacts-item' target='_blank' rel='noopener noreferrer'>
              <p>{contactList[contact].text}</p>
              <img src={contactList[contact].imgSrc} alt={contactList[contact].altText} />
            </a>
          )
        })}
        </div>
